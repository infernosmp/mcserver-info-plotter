...
# Date: 09/06/2024
# Description: This script imports data from the export.csv file which contains minecraft server info and turns it into a line graph.
...
plt.plot(top_10_countries, top_10_players, color='blue', marker='o', linestyle='-')
